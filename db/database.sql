...
create table langue ( id integer not null primary key auto_increment, name varchar(255) not null ) engine=innodb character set utf8 collate utf8_unicode_ci;
insert into langue values (1, 'Français' );
insert into langue values (2, 'Deutsch');
insert into langue values (3, 'Chinese');
...
create table traduction ( id integer not null primary key auto_increment, tag varchar(255) not null, langueId integer not null, FOREIGN KEY ( langueId) REFERENCES langue(id) ) engine=innodb character set utf8 collate utf8_unicode_ci;
